...
//        inputView.textContainer.lineFragmentPadding = 0.0f;
...
- (void)layoutSubviews
{
    ...
    self.my_inputView.frame = CGRectMake(self.my_voiceBtn.right + kWeChatPadding, self.my_voiceBtn.top, ChatScreenWidth - self.my_inputView.left*2, self.my_voiceBtn.height);
