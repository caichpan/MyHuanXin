...
@interface IChatCallViewController ()<EMCallManagerDelegate,AVCaptureVideoDataOutputSampleBufferDelegate>
{
...
@implementation IChatCallViewController
...
- (void)setup
{
    ...
    acceptBtn.frame = CGRectMake(kWeChatPadding*2, ChatScreenHeight - kWeChatAllSubviewHeight - kWeChatPadding, (ChatScreenWidth - (kWeChatPadding*2)*3)/2, kWeChatAllSubviewHeight);
    ...
    cancelBtn.frame = CGRectMake(acceptBtn.right + kWeChatPadding*2, ChatScreenHeight - kWeChatAllSubviewHeight - kWeChatPadding, (ChatScreenWidth - (kWeChatPadding*2)*3)/2, kWeChatAllSubviewHeight);
