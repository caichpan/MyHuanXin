...
- (void)viewDidLoad {
    ...
    __block MWPhotoBrowser *weak = self;
    XMGNButton *backButton = [XMGNButton buttonWithType:UIButtonTypeCustom];
    backButton.frame = CGRectMake(10, 50, 50, 20);
    backButton.backgroundColor = [UIColor redColor];
    backButton.block = ^(XMGNButton *btn){
