...
- (void)setImageLinkURL:(NSArray *)imageLinkURL
{
    ...
    _pageControl.currentPage = 0;
     ...
     [_leftImageView yy_setImageWithURL:imageLinkURL[leftImageIndex] placeholder:self.placeHoldImage];
     [_centerImageView yy_setImageWithURL:imageLinkURL[centerImageIndex] placeholder:self.placeHoldImage];
     [_rightImageView yy_setImageWithURL:imageLinkURL[rightImageIndex] placeholder:self.placeHoldImage];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
  ...
  //  [_rightImageView yy_setImageWithURL:imageLinkURL[rightImageIndex] placeholder:self.placeHoldImage];
    [_leftImageView yy_setImageWithURL:_imageLinkURL[leftImageIndex] placeholder:self.placeHoldImage];
    [_centerImageView yy_setImageWithURL:_imageLinkURL[centerImageIndex] placeholder:self.placeHoldImage];
    [_rightImageView yy_setImageWithURL:_imageLinkURL[rightImageIndex] placeholder:self.placeHoldImage];
